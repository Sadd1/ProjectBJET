...
<script type= "text/javascript" >
 ...
 frmvalidator.addValidation("voteridnumber","req","Please enter student VoterIdNumber"); 
 frmvalidator.addValidation("voteridnumber","maxlen=50");
 frmvalidator.addValidation("phonenumber","req","Please enter student PhoneNumber"); 
